...
function Navigation() {
    ...
    return (
        ...
        <div className = "row-wise-display">
            ...
            <div className = "row-wise-display">
            <img className = "row-img" src = {bathroomEssentials} alt = "bathroom essentials"></img>
        ...
        <div className = "shop-by-category">
            <span className = "shop-by-category-span">Shop by Category</span>
        </div>
        ...
        <div className = "category-card">
            ...
            <div className = "category-card">
            <img className = "category-img" src = {flour} alt = "cooking Essentials"></img>
